...
export class VotacionComponent implements OnInit, OnDestroy {
  ...
  getLocalDescripcion(nombre: string): string {
    const descripciones: { [key: string]: string } = {
      ...
      'Fratelli Reposteria': 'LA JAMAIQUINA 🌺 Galleta de mantequilla y macadamia, sobre una nube de vainilla, reducción de flor de jamaica, confitura de maracumango artesanal con trozos de fruta y un toque de menta.',
  ...
  getLocalImage(nombre: string): string {
    const images: { [key: string]: string } = {
      ...
      'Fratelli Reposteria': 'assets/img/FRATELI.jpeg',
  ...
  getLocalFondo(nombre: string): string {
    const fondos: { [key: string]: string } = {
      ...
      'Fratelli Reposteria': 'assets/img/FratelliFondo.jpeg',
